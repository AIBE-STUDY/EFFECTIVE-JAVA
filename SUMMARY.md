...
* [2️⃣ 객체 생성과 파괴](effective-java/section2/README.md)
  * [1. 생성자 대신 정적 팩터리 메서드를 고려하라](effective-java/section2/1.Consider static factory methods instead of constructors 5)
  * [2. 생성자에 매개변수가 많다면 빌더를 고려하라](effective-java/section2/2.Consider a builder when faced with many constructor parameters 10)
...
* [4️⃣ 클래스와 인터페이스](effective-java/section4/README.md)
  * [15. 클래스와 멤버의 접근 권한을 최소화하라](effective-java/section4/15..md)
  * [16. public 클래스에서는 public 필드가 아닌 접근자 메서드를 사용하라](effective-java/section4/16.-public-public.md)
  * [17. 변경 가능성을 최소화하라](effective-java/section4/17..md)
  * [18. 상속보다는 컴포지션을 사용하라](effective-java/section4/18..md)
  * [19. 상속을 고려해 설계하고 문서화하라. 그러지 않았다면 상속을 금지하라](effective-java/section4/19.-..md)
  * [20. 추상 클래스보다는 인터페이스를 우선하라](effective-java/section4/20..md)
  * [21. 인터페이스는 구현하는 쪽을 생각해 설계하라](effective-java/section4/21..md)
  * [22. 인터페이스는 타입을 정의하는 용도로만 사용하라](effective-java/section4/22..md)
* [5️⃣ 제네릭](effective-java/section5.md)
